...
/** Handles the scan requests that the LoadBalancer forwards to the WebServer. */
public class ScanHandler implements HttpHandler {
   ...
   * associated with the Request. Calculates the cost and stores it in the MSS, which will later be
   * fetched by the LoadBalancer.
   *
