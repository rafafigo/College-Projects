...
public class ScalingApp {
  ...
  /**
   * Initializes the auto-scaler and the load-balancer in different threads.
   *
   * @param args Command line arguments containing: image id, key pair name, security group.
   */
