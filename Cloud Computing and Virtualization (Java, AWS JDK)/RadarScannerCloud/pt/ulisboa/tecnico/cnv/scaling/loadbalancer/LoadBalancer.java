...
public class LoadBalancer {
  ...
  /** Gets a predefined capacity of costs associated with its requests. */
  ...
  /**
   * Gets the costs associated with the most recently received Requests, and places them in the
   * Cache.
   */
  ...
  /**
   * Gets the estimated cost of the incoming request, the WebServer instance that has the lowest
   ...
   * with the most recent Incoming Requests, every 30 seconds.
   */
   ...
   * responds to the health check or not. If detects an unhealthy Instance, removes it from the
