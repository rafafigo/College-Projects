...
class BulletCam extends THREE.PerspectiveCamera {
    ...
    update() {
        ...
        this.bullet.getWorldPosition(vector);
        this.position.set(
            vector.x + this.bullet.direction.x * 30,
            vector.y + 10,
            vector.z + this.bullet.direction.z * 30
        );
        this.lookAt(vector);
    }
