...
guarda_ninja_colidir: STRING 0
var_destroir: STRING 0
...
ninja_1:
  MOV R0, linha_nin1
  MOVB R1, [R0]              ; R1 - Linha guardada do primeiro ninja
  MOV R2, lin_i_n
  MOVB [R2], R1              ; R2 - Adiciona ao determinador da linha do ninja a colocar
  MOV R3, colun_nin1
  MOVB R4, [R3]              ; R4 - Coluna guardada pelo primeiro ninja
  MOV  R5, col_i_n
  MOVB [R5], R4		         ; R5 - determinador de coluna
