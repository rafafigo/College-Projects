function bar() {
    var share = localStorage.getItem("bar");
    switch(share) {
    case "1":
        share1();
        break;
...
function share3() {
    ...
    document.getElementById("desc").innerHTML = "Foxtrot" + "<br>" + "Avenida Santa Teresa" + "<br>" + "Rating";
    document.getElementById("star1").src = "../../../images/star.png";
    document.getElementById("star2").src = "../../../images/star.png";
    document.getElementById("star3").src = "../../../images/star.png";
    document.getElementById("star4").src = "../../../images/star.png";
...
function share4() {
    ...
    document.getElementById("desc").innerHTML = "Bruxa Beer Bar" + "<br>" + "Rua de São Mamede" + "<br>" + "Rating";
    document.getElementById("star1").src = "../../../images/star.png";
    document.getElementById("star2").src = "../../../images/star.png";
    document.getElementById("star3").src = "../../../images/star.png";
    document.getElementById("star4").src = "../../../images/star.png";
