        ...
        'layout': [
            ...
            [
                [
                    ...
                    ['i', 'i', 73, 0, false], ['o', 'o', 79, 0, false], ['p', 'p', 80, 0, false], ['a', 'a', 65, 0, false], ['s', 's', 83, 0, false], ['d', 'd', 68, 0, false], ['f', 'f', 70, 0, false],
                    ['g', 'g', 71, 0, false], ['h', 'h', 72, 0, false], ['j', 'j', 74, 0, false], ['k', 'k', 75, 0, false], ['l', 'l', 76, 0, false], ['z', 'z', 90, 0, false], ['x', 'x', 88, 0, false], 
                    ['c', 'c', 67, 0, false], ['v', 'v', 86, 0, false], ['b', 'b', 66, 0, false],  ['n', 'n', 78, 0, false], ['m', 'm', 77, 0, false], ['Bksp', '8', 8, 2, false], 
                    ['Shift&ensp;123', '16', 16, 2, true], ['Space', '32', 32, 12, false], ['Enter', '13', 13, 13, false],
                ],
                [   ['1', '1', 49, 1, true], ['2', '2', 50, 1, false], ['3', '3', 51, 1, false], ['4', '4', 52, 1, false], ['5', '5', 53, 1, false], ['&#92;', '\\', 220, 1, false], ['-', '-', 189, 1, false],
                    ['6', '6', 54, 1, true], ['7', '7', 55, 1, false], ['8', '8', 56, 1, false], ['9', '9', 57, 1, false], ['0', '0', 48, 1, false], [',', ',', 188, 1, false], ['.', '.', 190, 1, false],
                    ['Q', 'Q', 81, 0, true], ['W', 'W', 87, 0, false], ['E', 'E', 69, 0, false], ['R', 'R', 82, 0, false], ['T', 'T', 84, 0, false], ['Y', 'Y', 89, 0, false], ['U', 'U', 85, 0, false],
                    ['I', 'I', 73, 0, false], ['O', 'O', 79, 0, false], ['P', 'P', 80, 0, false], ['A', 'A', 65, 0, false], ['S', 'S', 83, 0, false], ['D', 'D', 68, 0, false], ['F', 'F', 70, 0, false],
                    ['G', 'G', 71, 0, false], ['H', 'H', 72, 0, false], ['J', 'J', 74, 0, false], ['K', 'K', 75, 0, false], ['L', 'L', 76, 0, false], ['Z', 'Z', 90, 0, false], ['X', 'X', 88, 0, false],
                    ['C', 'C', 67, 0, false], ['V', 'V', 86, 0, false], ['B', 'B', 66, 0, false], ['N', 'N', 78, 0, false], ['M', 'M', 77, 0, false], ['Bksp', '8', 8, 2, false],
        ...
        */
        ...
        switch(keyCode){
            ...
            case 16:    // shift key
                ...
                var size = (shiftExch = shiftExch ? false : true) ? 109 : 53;
                var elements = document.getElementsByClassName("jQKeyboardContainer");

                for(var i = 0; i < elements.length; i++) {
                    elements[i].style.marginTop = size + "px";
                }
